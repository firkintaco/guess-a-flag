<script>
    ...
    import {isCorrect,countryId,countries, score, isQuestionAnswered, isLoading, isError} from '../stores/store.js';
...
<div class="max-w-lg rounded overflow-hidden shadow-lg bg-white">
    ...
    <div class="text-center">
        <span class="text-gray-400">{$countryId}/{$countries.length}</span>
        </div>
    </div>
  </div>